...
export const TermsModal: React.FC<TermsModalProps> = ({ visible, onAgree, onDisagree }) => {
    return (
        <Modal
            visible={visible}
            transparent={true}
                ...
                <View style={styles.container}>
                    ...
                    <View style={styles.termsBoxContainer}>
                        <ScrollView style={styles.termsScroll} contentContainerStyle={{ padding: 16 }}>
                            ...
                            <Text style={styles.sectionTitle}>1. 우편물 알림</Text>
                            ...
                            <Text style={styles.sectionTitle}>2. 보관기간</Text>
                            <Text style={styles.termsText}>
                                • 일반 우편물 보관기간: 14일{'\n'}
                                • 보관기간 경과 시 별도 통보 없이 폐기됩니다.
                            </Text>

                            <Text style={styles.sectionTitle}>3. 택배 수령</Text>
                            <Text style={styles.termsText}>
                                • 택배 수령은 원칙적으로 불가합니다.{'\n'}
                                • 부득이하게 수령된 경우 보관료가 발생할 수 있습니다. (1일 1,000원)
                            </Text>

                            <Text style={styles.sectionTitle}>4. 수령 제외 우편물</Text>
                            <Text style={styles.termsText}>
                            ...
                            <Text style={styles.sectionTitle}>5. 정기 고지·안내 우편물</Text>
                            <Text style={styles.termsText}>
                            ...
                            <Text style={styles.sectionTitle}>6. 폐기 대상 우편물</Text>
                            <Text style={styles.termsText}>
                                우편 담당자가 스팸성 또는 단순 안내성 우편물로 판단하는 경우 별도 알림 없이 즉시 폐기할 수 있습니다.{'\n'}
                                • 홍보물, 팸플릿, 카탈로그, 책자, 기타 광고물
                            </Text>

                            <Text style={styles.sectionTitle}>7. 등기 및 특별송달</Text>
                            <Text style={styles.termsText}>
                            ...
                            <Text style={styles.sectionTitle}>8. 대형 우편물</Text>
                            <Text style={styles.termsText}>
                            ...
                            <Text style={styles.sectionTitle}>9. 면책사항</Text>
                            <Text style={styles.termsText}>
